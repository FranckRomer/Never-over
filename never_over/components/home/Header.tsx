        ...
        <div className={styles.Header}>
            <div className={styles.inicio}>
                ...
                <button className={styles.links}>
                    ...
                    <Link href="/login/profile" className={styles.link}><Image src="/ico/userWhite.ico" alt='Notificaciones' width={20} height={20} /> <p>User</p></Link>
                ...
                modal ?
                    <div className={styles.modalOpen}>
                        ...
                        <ul className={styles.menu}>
                            ...
                            <Link href="/login/profile" className={styles.linkMenu}><li><Image src="/ico/userWhite.ico" alt='Notificaciones' width={20} height={20} /> User</li></Link>
                            <hr />
